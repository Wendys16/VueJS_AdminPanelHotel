        ...
        <div v-if="modalEliminar" class="modal">
            <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <transition enter-active-class="ease-out duration-300" enter-from-class="opacity-0"
                    ...
                    <div class="fixed inset-0 z-10 w-screen overflow-y-auto" v-show="modalEliminar">
                            ...
                            <transition enter-active-class="ease-out duration-300"
                                ...
                                <div v-show="modalEliminar"
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                        ...
                                        <button type="button" @click="closeModalEliminar"
...
export default {
    ...
    methods: {
        closeModalEliminar() {
            this.$emit('close-modal-eliminar');
        },
    },
};
</script>